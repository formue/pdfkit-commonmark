...
var _commonmarkPdfkitRenderer = _interopRequireDefault(require("./commonmark-pdfkit-renderer.js"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { "default": e }; }
// get input file info
var inputFilePath = process.argv[2];
var absInputFilePath = _path["default"].resolve(process.cwd(), inputFilePath);
...
var absOutputFilePath = _path["default"].resolve(process.cwd(), outputFilePath);
var fileContents, parsed;
...
// get parser instance
var reader = new _commonmark.Parser();
...
var writer = new _commonmarkPdfkitRenderer["default"]();

// create pdf document
var doc = new _pdfkit["default"]();

// pipe document to output file
doc.pipe(_fs["default"].createWriteStream(absOutputFilePath));
